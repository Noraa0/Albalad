...
class MuseumReservationVC: UIViewController {

    
    let db = Firestore.firestore()

    var museumNameSelected = 0
    ...
    override func viewDidLoad() {
        ...
        setUp()
            ...
            if museumNameSelected == 0 {
                nameLable.text = "بيت البلد"
                priceLabel.text = "٣٠٠ريال"
                
            }else if museumNameSelected == 1 {
                nameLable.text = "بيت نصيف"
                priceLabel.text = "٣٥٠ريال"
                
            }else if museumNameSelected == 2 {
                nameLable.text = "بيت باعشن"
                priceLabel.text = "٤٠٠ريال"
                
            }else if museumNameSelected == 3 {
                nameLable.text = "بيت سليمان قابل"
                priceLabel.text = "٢٠٠ريال"
            }
    }
}
