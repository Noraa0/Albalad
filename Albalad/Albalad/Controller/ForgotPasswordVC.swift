...
//  Albalad
//
//  Created by Nora on 03/06/1443 AH.
//
...
class ForgotPasswordVC: UIViewController {
    ...
    func setUp() {
        ...
        cancelBtn.layer.borderColor = #colorLiteral(red: 0.2538028657, green: 0.2592750192, blue: 0.2415924966, alpha: 1)
        cancelBtn.layer.cornerRadius = cancelBtn.frame.height/2
        cancelBtn.setTitleColor(#colorLiteral(red: 0.2538028657, green: 0.2592750192, blue: 0.2415924966, alpha: 1), for: .normal)
        cancelBtn.setTitle("الغاء", for: .normal)
        cancelBtn.addTarget(self, action: #selector(cancel), for: .touchUpInside)
        
        //Return Password Btn
        returnBtn.frame = CGRect(x: 200 , y: 550, width: width/2-10, height: height/4)
        returnBtn.backgroundColor = #colorLiteral(red: 0.2538028657, green: 0.2592750192, blue: 0.2415924966, alpha: 1)
