//
//  ConfirmationVCViewController.swift
//  Albalad
//
...
class HotelReservationVC: UIViewController {
    
    
    let db = Firestore.firestore()
    
    var hotelNameSelected = 0
    ...
    override func viewDidLoad() {
        ...
        if hotelNameSelected == 0 {
            nameLable.text = "فندق برايم"
            priceLabel.text = "٤٣٠ريال"
            
        }else if hotelNameSelected == 1 {
            nameLable.text = "الفندق الذهبي"
            priceLabel.text = "٢٠٨ريال"

        }else if hotelNameSelected == 2 {
            nameLable.text = "فندق النهضة"
            priceLabel.text = "١٣٩ريال"

        }else if hotelNameSelected == 3 {
            nameLable.text = "فندق توق بلد"
            priceLabel.text = "١٣٩ريال"
